...
import 'package:personal_history/screens/patientScreens/mawaidy/addMawaidy.dart';
import 'package:personal_history/widgets/CustomButton.dart';
import 'package:table_calendar/table_calendar.dart';

class Mawaidy extends StatefulWidget {
  const Mawaidy({super.key});

  @override
  State<Mawaidy> createState() => _MawaidyState();
}

class _MawaidyState extends State<Mawaidy> {
                    ...
                    CustomButton(
                      ...
                      ontap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const Addmawaidy(),
                          ),
                        );
                      },
                    )
